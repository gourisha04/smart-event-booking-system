export const fallbackEvents = [
  {
    ...
    description:
      "An open-air night concert featuring live bands, DJs, food stalls, and rooftop after-party experiences.",
  ...
  },
  {
    ...
    description:
      "A global conference focused on AI, robotics, startups, and the future of digital innovation.",
  ...
  },
  {
    ...
    description:
      "Networking event bringing together founders, investors, creators, and entrepreneurs.",
  ...
  {
    id: 4,
    title: "Neon Fashion Week",
    category: "Fashion",
    date: "2026-09-02",
    image: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1",
    img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1",
    description:
      "Luxury fashion showcase with celebrity designers and immersive runway experiences.",
  ...
  },
  {
    ...
    description:
      "Massive gaming event featuring esports tournaments, VR zones, and gaming creators.",
  ...
  },
  {
    ...
    description:
      "International food celebration with chefs, live cooking shows, and cultural performances.",
    location: "Dubai, UAE",
    vip_price: 2999,
    standard_price: 999,
    total_seats: 350,
